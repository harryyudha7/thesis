...
if __name__ == "__main__":
    ...
    for j in act_func:
        ...
        fmodel, params, funcs = make_forward_fn(
            num_hidden=num_hidden, dim_hidden=dim_hidden, derivative_order=2, act= j
        )
        ...
        if loss_evolution[-1] < min_loss:
            ...
            min_param = params
        print(loss_evolution[-1], min_loss)
    ...
    ax.legend()
    print(np.sum((f_eval.detach().numpy() - analytical_sol_fn(x_eval_np))**2))
    plt.show()
